<template>
  <article class="content-area">
    ...
    <p>As an example, <label for="uri-example-1">the code snippet below creates a scene filled with a fictional 'Duke.png' image, located in an
    'image' directory:</label></p>
    <textarea id="uri-example-1" readonly="readonly" rows="9" cols="132">
    ...
    <div class="pagination">
      <router-link to="/css/color-stop" class="btn btn-prev">❮ &lt;color-stop&gt;</router-link>
      <router-link to="/css/effect" class="btn btn-next">&lt;effect&gt; ❯</router-link>
    </div>
  </article>
</template>
