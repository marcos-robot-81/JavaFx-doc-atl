<template>
  <article class="content-area">
    ...
    <div class="pagination">
      <router-link to="/css/passwordfield" class="btn btn-prev">❮ PasswordField</router-link>
      <router-link to="/css/progressbar" class="btn btn-next">ProgressBar ❯</router-link>
    </div>
  </article>
</template>
