<template>
  <article class="content-area">
    ...
    <div class="pagination">
      <router-link to="/css/css-public-api" class="btn btn-prev">❮ CSS Public API</router-link>
      <router-link to="/css/transitions" class="btn btn-next">Transitions ❯</router-link>
    </div>
  </article>
</template>
