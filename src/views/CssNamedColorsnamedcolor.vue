<template>
  <article class="content-area">
    ...
    <div class="pagination">
      <router-link to="/css/color" class="btn btn-prev">❮ &lt;color&gt;</router-link>
      <router-link to="/css/looked-up-colors-looked-up-color" class="btn btn-next">Looked-up Colors &lt;looked-up-color&gt; ❯</router-link>
    </div>
  </article>
</template>
