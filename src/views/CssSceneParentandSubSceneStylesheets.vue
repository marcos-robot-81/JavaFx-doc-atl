<template>
  <article class="content-area">
    ...
    <p>
        ...
        <a href="https://openjfx.io/javadoc/26/javafx.graphics/javafx/scene/Scene.html#getStylesheets--">getStylesheets</a>
    ...
    <p>
        ...
        <a href="https://openjfx.io/javadoc/26/javafx.graphics/javafx/scene/Parent.html#getStylesheets--">getStylesheets</a> property,
    ...
    <p>
        ...
        <a href="https://openjfx.io/javadoc/26/javafx.graphics/javafx/scene/Scene.html#getUserAgentStylesheet--">getUserAgentStylesheet</a> property,
    ...
    <p>
        ...
        <a href="https://openjfx.io/javadoc/26/javafx.graphics/javafx/scene/SubScene.html#getUserAgentStylesheet--">getUserAgentStylesheet</a> property,
    ...
    <div class="pagination">
      <router-link to="/css/css-and-the-javafx-scene-graph" class="btn btn-prev">❮ CSS and the JavaFX Scene Graph</router-link>
      <router-link to="/css/naming-conventions" class="btn btn-next">Naming Conventions ❯</router-link>
    </div>
  </article>
</template>
