<template>
  <article class="content-area">
    ...
    <h4>Substructure</h4>
    <ul>
      <li>tab-header-area — StackPane
      <ul>
        <li>headers-region — StackPane</li>
        <li>tab-header-background — StackPane</li>
        <li>control-buttons-tab — StackPane
        <ul>
          <li>tab-down-button — Pane
          <ul>
    ...
    <div class="pagination">
      <router-link to="/css/splitpane" class="btn btn-prev">❮ SplitPane</router-link>
      <router-link to="/css/tablecolumnheader" class="btn btn-next">TableColumnHeader ❯</router-link>
    </div>
  </article>
</template>
