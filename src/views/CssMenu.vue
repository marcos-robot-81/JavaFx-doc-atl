<template>
  <article class="content-area">
    ...
    <div class="pagination">
      <router-link to="/css/listview" class="btn btn-prev">❮ ListView</router-link>
      <router-link to="/css/menubar" class="btn btn-next">MenuBar ❯</router-link>
    </div>
  </article>
</template>
