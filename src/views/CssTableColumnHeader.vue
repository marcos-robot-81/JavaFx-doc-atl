<template>
  <article class="content-area">
    ...
    <ul>
        ...
        <li>column-header-background — StackPane
        <ul>
            ...
            <li>filler — Region</li>
            <li>show-hide-columns-button — StackPane
            <ul>
                <li>show-hide-column-image — StackPane</li>
            </ul>
            </li>
            <li>column-drag-header — StackPane
            <ul>
                <li>label — Label</li>
            </ul>
            </li>
    ...
    <div class="pagination">
      <router-link to="/css/tabpane" class="btn btn-prev">❮ TabPane</router-link>
      <router-link to="/css/tableview" class="btn btn-next">TableView ❯</router-link>
    </div>
  </article>
</template>
