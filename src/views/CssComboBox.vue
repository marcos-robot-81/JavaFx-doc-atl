<template>
  <article class="content-area">
    <section class="doc-section glass-panel">
      <h4><a id="combobox">ComboBox</a></h4>
    ...
    <ul>
      ...
      <li>text-input — a TextField instance used to show the selection and
    ...
    <div class="pagination">
      <router-link to="/css/colorpicker" class="btn btn-prev">❮ ColorPicker</router-link>
      <router-link to="/css/comboboxbase" class="btn btn-next">ComboBoxBase ❯</router-link>
    </div>
  </article>
</template>
