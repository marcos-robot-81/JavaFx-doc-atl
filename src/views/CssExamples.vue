<template>
  <article class="content-area">
    ...
    <p><img src="/img/cssexample1_Sj7H.png" alt="A rectangle with red fill"></p>
    ...
    <p><img src="/img/cssexample2_Sj7H.png" alt="A rectangle with yellow fill and a green, dashed border"></p>
    </section>
    <div class="pagination">
      <router-link to="/css/media" class="btn btn-prev">❮ @media</router-link>
      <router-link to="/css/understanding-----parser-warnings" class="btn btn-next">Understanding         Parser Warnings ❯</router-link>
    </div>
  </article>
</template>
