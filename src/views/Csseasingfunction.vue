<template>
  <article class="content-area">
    ...
    <p class="grammar">linear | &lt;linear-easing-function&gt; | 
&lt;cubic-bezier-easing-function&gt; | &lt;step-easing-function&gt; | 
&lt;fx-easing-function&gt;</p>
    ...
    <figure style="display: inline-block">
        <img src="/img/easing-linear_Sj7H.svg" width="200" alt="Linear easing function">
    </figure>
    ...
    <figure style="display: inline-block">
        <img src="/img/easing-linear-func1_Sj7H.svg" width="200" alt="linear easing function">
        <figcaption style="margin-left: 40px" class="grammar">linear(0, 0.25, 1)</figcaption>
    </figure>
    <figure style="display: inline-block">
        <img src="/img/easing-linear-func2_Sj7H.svg" width="200" alt="linear easing function">
        <figcaption style="margin-left: 20px" class="grammar">linear(0, 0.25 75%, 1)</figcaption>
    </figure>
    <figure style="display: inline-block">
        <img src="/img/easing-linear-func3_Sj7H.svg" width="200" alt="linear easing function">
    ...
    <table class="table table-dark table-striped table-hover table-bordered"  role="presentation" summary="Cubic Bézier Easing Functions">
        <tbody><tr>
    ...
    <figure style="display: inline-block">
        <img src="/img/easing-cubicbezier_Sj7H.svg" width="200" alt="Cubic Bèzier easing function">
    </figure>
    ...
    <p>The values have the following meaning:</p>
    <table class="table table-dark table-striped table-hover table-bordered"  role="presentation" summary="Step Easing Functions">
        <tbody><tr>
        ...
        <tr>
            ...
            <td>defines a step function with <a href="#typenumber" class="typelink">&lt;integer&gt;</a> intervals
                ...
                <span class="grammar">end</span> is implied
            </td>
        </tr>
        <tr><td><br></td></tr>
        <tr>
    ...
    <figure style="display: inline-block">
        <img src="/img/easing-stepstart_Sj7H.svg" width="200" alt="jump-start easing function">
        <figcaption style="margin-left: 30px" class="grammar">steps(3, jump-start)</figcaption>
    </figure>
    <figure style="display: inline-block">
        <img src="/img/easing-stepend_Sj7H.svg" width="200" alt="jump-end easing function">
        <figcaption style="margin-left: 30px" class="grammar">steps(3, jump-end)</figcaption>
    </figure>
    <figure style="display: inline-block">
        <img src="/img/easing-stepnone_Sj7H.svg" width="200" alt="jump-none easing function">
        <figcaption style="margin-left: 30px" class="grammar">steps(3, jump-none)</figcaption>
    </figure>
    <figure style="display: inline-block">
        <img src="/img/easing-stepboth_Sj7H.svg" width="200" alt="jump-both easing function">
    ...
    <p>The values have the following meaning:</p>
    <table class="table table-dark table-striped table-hover table-bordered"  role="presentation" summary="SMIL 3.0 Easing Functions">
        <tbody><tr>
    ...
    <div class="pagination">
      <router-link to="/css/color-functions-color-function" class="btn btn-prev">❮ Color Functions &lt;color-function&gt;</router-link>
      <router-link to="/css/text-bounds" class="btn btn-next">&lt;text-bounds&gt; ❯</router-link>
    </div>
  </article>
</template>
