...
public class MyController implements Initializable {
    ...
    protected void initialize()
      ...
      <div class="info-alert">
        <strong>HTML Analogy:</strong> The @FXML annotation in JavaFX is similar
        to using the id attribute in HTML and accessing it via
        document.getElementById() in JavaScript, bridging the UI markup with the
        controller logic.
      </div>
      <div class="code-block">
        <div class="code-header">Example</div>
...
&lt;/script&gt;</code></pre>
    ...
    <div class="pagination">
      <router-link to="/fxml/controllers" class="btn btn-prev"
        >❮ Controllers</router-link
      >
      <router-link to="/fxml/nested-controllers" class="btn btn-next"
