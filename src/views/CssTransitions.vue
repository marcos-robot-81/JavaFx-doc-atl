  ...
  <article class="content-area">
    ...
    <p>A transition is not started (or cancelled if already running) in any of these scenarios:
        ...
        <li>The node (or any of its parents) is invisible, as indicated by the
            <a href="https://openjfx.io/javadoc/26/javafx.graphics/javafx/scene/Node.html#visibleProperty()">Node.visible</a> property</li>
        <li>The node is removed from the scene graph</li>
      </ol>
    <p></p>
    Nodes fire <a href="https://openjfx.io/javadoc/26/javafx.graphics/javafx/css/TransitionEvent.html">TransitionEvent</a> to signal the creation,
    beginning, completion and cancellation of transitions.
    </section>
    <div class="pagination">
      <router-link to="/css/inheritance" class="btn btn-prev">❮ Inheritance</router-link>
      <router-link to="/css/example" class="btn btn-next">Example ❯</router-link>
    </div>
  </article>
</template>
