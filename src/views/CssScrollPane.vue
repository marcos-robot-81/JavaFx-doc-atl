<template>
  <article class="content-area">
    ...
    <div class="pagination">
      <router-link to="/css/scrollbar" class="btn btn-prev">❮ ScrollBar</router-link>
      <router-link to="/css/separator" class="btn btn-next">Separator ❯</router-link>
    </div>
  </article>
</template>
