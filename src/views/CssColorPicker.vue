<template>
  <article class="content-area">
    <section class="doc-section glass-panel">
      <h4><a id="colorpicker">ColorPicker</a></h4>
    ...
    <h4>Substructure</h4>
    <ul>
	  <li>color display node  — Label</li>
      <li>arrow-button — StackPane
	    <ul>
    ...
    <div class="pagination">
      <router-link to="/css/choicebox" class="btn btn-prev">❮ ChoiceBox</router-link>
      <router-link to="/css/combobox" class="btn btn-next">ComboBox ❯</router-link>
    </div>
  </article>
</template>
