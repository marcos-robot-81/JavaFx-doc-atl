...
<div class="info-alert"><strong>HTML Analogy:</strong> In HTML and Web development, attaching event handlers to elements is a fundamental concept for interactivity. You can do this inline (like <code>onclick</code>), which is akin to FXML script or expression handlers, or you can attach them via JavaScript using <code>addEventListener</code>. Similarly, modern frameworks like Vue or React use a declarative syntax to bind events to controller/component methods.</div>
<div class="code-block"><div class="code-header">Web Equivalent</div><pre><code>&lt;!-- Inline event handler --&gt;
&lt;button onclick="console.log('You clicked me!')"&gt;Click Me!&lt;/button&gt;

&lt;!-- Framework declarative handler (Vue.js) --&gt;
&lt;button @click="handleButtonAction"&gt;Click Me!&lt;/button&gt;</code></pre></div>
    </section>
    <div class="pagination">
      <router-link to="/fxml/expression-binding" class="btn btn-prev">❮ Expression Binding</router-link>
      <router-link to="/fxml/script-event-handlers" class="btn btn-next">Script Event Handlers ❯</router-link>
    </div>
  </article>
</template>
