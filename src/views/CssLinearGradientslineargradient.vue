<template>
  <article class="content-area">
    ...
    <p class="grammar">linear-gradient( [ [from <a href="#typepoint" class="typelink">&lt;point&gt;</a>
      ...
      &lt;side-or-corner&gt;], ]? [ [ repeat | reflect ], ]? <a href="#typecolorstop" class="typelink">&lt;color-stop&gt;</a>[,
    ...
    <p> If neither repeat nor reflect are given, then the CycleMethod defaults
      ...
      to 'to bottom'.<br>
      Stops are per <a href="http://dev.w3.org/csswg/css3-images/#color-stop-syntax." class="typelink">W3C
    ...
    <div class="pagination">
      <router-link to="/css/paint" class="btn btn-prev">❮ &lt;paint&gt;</router-link>
      <router-link to="/css/radial-gradients-------radial-gradient" class="btn btn-next">Radial Gradients              &lt;radial-gradient&gt; ❯</router-link>
    </div>
  </article>
</template>
