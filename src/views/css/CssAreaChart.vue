<template>
  <article class="content-area">
    <section class="doc-section glass-panel">
      ...
      <table class="table table-dark table-striped table-hover table-bordered">
        ...
        <tbody>
          ...
          <tr>
            <th class="propertyname" scope="row">
              "chart-area-symbol series&lt;i&gt; data&lt;j&gt;
              default-color&lt;k&gt;"
            </th>
            <td>
          ...
          <tr>
            <th class="propertyname" scope="row">
              "chart-area-symbol series&lt;i&gt; area-legend-symbol
              default-color&lt;j&gt;"
            </th>
            <td>
              Where &lt;i&gt; is the index of the series and &lt;j&gt; is the
    ...
    <div class="pagination">
      <router-link to="/css/charts" class="btn btn-prev">❮ Charts</router-link>
      <router-link to="/css/axis" class="btn btn-next">Axis ❯</router-link>
    </div>
  </article>
</template>
