<template>
  <article class="content-area">
    <section class="doc-section glass-panel">
      <h4><a id="menubutton">MenuButton</a></h4>
    ...
    <div class="pagination">
      <router-link to="/css/menubar" class="btn btn-prev">❮ MenuBar</router-link>
      <router-link to="/css/menuitem" class="btn btn-next">MenuItem ❯</router-link>
    </div>
  </article>
</template>
