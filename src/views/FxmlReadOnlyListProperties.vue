...
<p>As each sub-element of the <span class="code">&lt;children&gt;</span> element is read, it is added to the list returned by <span class="code">Group#getChildren()</span>.
      ...
      <div class="info-alert"><strong>HTML Analogy:</strong> In HTML, a `&lt;ul&gt;` or `&lt;ol&gt;` element acts like a read-only list property for list items (`&lt;li&gt;`). The parent provides the collection, and you simply add children to populate it.</div>
      <div class="code-block"><div class="code-header">Example</div><pre><code>&lt;ul&gt;
    &lt;li&gt;First item&lt;/li&gt;
    &lt;li&gt;Second item&lt;/li&gt;
&lt;/ul&gt;</code></pre></div>
    </section>
    <div class="pagination">
      <router-link to="/fxml/property-setters" class="btn btn-prev">❮ Property Setters</router-link>
      <router-link to="/fxml/read-only-map-properties" class="btn btn-next">Read-Only Map Properties ❯</router-link>
    </div>
  </article>
</template>
