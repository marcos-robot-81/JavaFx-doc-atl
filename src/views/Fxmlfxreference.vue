...
<p>In web development, referencing an existing element by its ID is similar to how the <code>for</code> attribute in a <code>&lt;label&gt;</code> points to an <code>&lt;input&gt;</code>'s ID, or how SVG <code>&lt;use&gt;</code> tags reference other graphics using their ID.</p>
<div class="code-block"><div class="code-header">Example</div><pre><code>&lt;!-- Referencing an ID in HTML --&gt;
...
&lt;/svg&gt;</code></pre></div>
    ...
    <div class="pagination">
      <router-link to="/fxml/fx-constant" class="btn btn-prev">❮ &lt;fx:constant&gt;</router-link>
      <router-link to="/fxml/fx-copy" class="btn btn-next">&lt;fx:copy&gt; ❯</router-link>
    </div>
  </article>
</template>
