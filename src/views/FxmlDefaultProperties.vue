...
<p>Taking advantage of default properties can significantly reduce the verbosity of FXML markup.</p>
      ...
      <div class="info-alert"><strong>HTML Analogy:</strong> In HTML, child elements are naturally added to a default "children" collection of their parent node without needing to specify a `&lt;children&gt;` wrapper tag.</div>
      <div class="code-block"><div class="code-header">Example</div><pre><code>&lt;div&gt;
    &lt;!-- Automatically added as children of the div --&gt;
    &lt;button&gt;Click Me!&lt;/button&gt;
&lt;/div&gt;</code></pre></div>
    </section>
    <div class="pagination">
      <router-link to="/fxml/read-only-map-properties" class="btn btn-prev">❮ Read-Only Map Properties</router-link>
      <router-link to="/fxml/static-properties" class="btn btn-next">Static Properties ❯</router-link>
    </div>
  </article>
</template>
