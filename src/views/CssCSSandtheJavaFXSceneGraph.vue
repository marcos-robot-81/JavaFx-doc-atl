<template>
  <article class="content-area">
    ...
    <p>CSS styles are applied to nodes in the JavaFX scene‑graph in a way
        ...
        <a href="https://openjfx.io/javadoc/26/javafx.graphics/javafx/scene/Node.html#applyCss--">applyCss</a> for more details.</p>
    ...
    <p>
        ...
        <li>
            Node's <a href="https://openjfx.io/javadoc/26/javafx.graphics/javafx/scene/Node.html#getTypeSelector--">getTypeSelector</a> method returns a
        ...
        <li>
            Each node in the scene‑graph has a <a href="https://openjfx.io/javadoc/26/javafx.graphics/javafx/scene/Node.html#getStyleClass--">styleClass
            property</a>.
    ...
    <p>
        ...
        rule's selector as described in CSS 2 <a href="https://openjfx.io/javadoc/26/javafx.graphics/javafx/scene/doc-files/cssref.html#references">[1]</a>
    ...
    <div class="pagination">
      <router-link to="/css/introduction" class="btn btn-prev">❮ Introduction</router-link>
      <router-link to="/css/scene-parent-and-subscene-stylesheets" class="btn btn-next">Scene, Parent and SubScene Stylesheets ❯</router-link>
    </div>
  </article>
</template>
