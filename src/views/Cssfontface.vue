<template>
  <article class="content-area">
    <section class="doc-section glass-panel">
      <h4>@font-face</h4>
    <p>Since JavaFX 8, the implementation partially supports the <label for="font-face-example-1">CSS3 syntax to load a font from a URL</label> using the
    <a href="http://www.w3.org/TR/css3-fonts/#the-font-face-rule">@font‑face</a> rule:</p>
    <textarea id="font-face-example-1" readonly="readonly" rows="8" cols="132">
     @font-face {
        font-family: 'sample';
        font-style: normal;
        font-weight: normal;
    ...
    "http://font.samples/web?family=samples" returns the @font‑face rule given above. Then the
        following code shows <label for="font-face-example-2">how the sample font could be used in a JavaFX application.</label></p>
    <textarea id="font-face-example-2" readonly="readonly" rows="20" cols="132">
