<template>
  <article class="content-area">
    <section class="doc-section glass-panel">
      <h4><a id="datepicker">DatePicker</a></h4>
    ...
    <h4>Substructure</h4>
    <ul>
        <li>date-picker-display-node  — TextField</li>
    </ul>
    </section>
    <div class="pagination">
      <router-link to="/css/control" class="btn btn-prev">❮ Control</router-link>
      <router-link to="/css/htmleditor" class="btn btn-next">HTMLEditor ❯</router-link>
    </div>
  </article>
</template>
