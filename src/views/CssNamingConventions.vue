<template>
  <article class="content-area">
    ...
    <div class="pagination">
      <router-link to="/css/scene-parent-and-subscene-stylesheets" class="btn btn-prev">❮ Scene, Parent and SubScene Stylesheets</router-link>
      <router-link to="/css/css-public-api" class="btn btn-next">CSS Public API ❯</router-link>
    </div>
  </article>
</template>
