<template>
  <article class="content-area">
    <section class="doc-section glass-panel">
      <h4><a id="comboboxbase">ComboBoxBase</a></h4>
    ...
    <h4>Substructure</h4>
    <ul>
      <li>arrow-button — a StackPane
        <ul>
          <li>arrow — a StackPane </li>
        </ul>
      </li>
    </ul>
    ...
    <div class="pagination">
      <router-link to="/css/combobox" class="btn btn-prev">❮ ComboBox</router-link>
      <router-link to="/css/contextmenu" class="btn btn-next">ContextMenu ❯</router-link>
    </div>
  </article>
</template>
