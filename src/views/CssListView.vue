<template>
  <article class="content-area">
    ...
    <h4>Substructure</h4>
    <ul>
        <li>.list-view — the ListView&lt;T&gt;
            <ul>
                <li>.virtual-flow — VirtualFlow
                    <ul>
                        <li>.clipped-container — <a href="#region">Region</a>
                            <ul>
                                <li>.sheet — Group
                                    <ul><li>.cell.indexed-cell.list-cell — <a href="#listcell">ListCell&lt;T&gt;</a></li></ul>
                                </li><li>.scroll-bar — <a href="#scrollbar">ScrollBar</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
    ...
    <div class="pagination">
      <router-link to="/css/listcell" class="btn btn-prev">❮ ListCell</router-link>
      <router-link to="/css/menu" class="btn btn-next">Menu ❯</router-link>
    </div>
  </article>
</template>
