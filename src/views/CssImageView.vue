    ...
    <caption>Available CSS Properties</caption>
      ...
      <tbody>
        ...
        <tr>
          ...
          <tr><th class="propertyname" scope="row">-fx-image</th>
        ...
        <tr>
          ...
          <td>Indicates whether to preserve the aspect ratio of the 
source image when scaling to fit the image within the fitting bounding 
box.</td>
        </tr>
        <tr>
          ...
          <td>Indicates whether to use a better quality filtering 
algorithm or a faster one when transforming or scaling the source image 
to fit.</td>
        </tr>
        <tr>
    ...
    <h3 class="package">javafx.scene.layout</h3>
    <br>
    </section>
    <div class="pagination">
      <router-link to="/css/scene" class="btn btn-prev">❮ Scene</router-link>
      <router-link to="/css/anchorpane" class="btn btn-next">AnchorPane ❯</router-link>
    </div>
  </article>
</template>
