<template>
  <article class="content-area">
    ...
    <h4>Substructure</h4>
    <ul>
      <li>split-pane-divider — StackPane
      <ul>
    ...
    <div class="pagination">
      <router-link to="/css/splitmenubutton" class="btn btn-prev">❮ SplitMenuButton</router-link>
      <router-link to="/css/tabpane" class="btn btn-next">TabPane ❯</router-link>
    </div>
  </article>
</template>
