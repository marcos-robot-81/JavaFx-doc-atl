...
&lt;/Button&gt;</code></pre>
      ...
      <div class="info-alert">
        <strong>HTML Analogy:</strong> Native HTML doesn't support reading class constants directly. The closest web equivalent is binding to JavaScript constants or global objects in a framework like Vue or React.
      </div>
      <div class="code-block">
...
&lt;/button&gt;</code></pre>
    ...
    <div class="pagination">
      <router-link to="/fxml/fx-include" class="btn btn-prev">❮ &lt;fx:include&gt;</router-link>
      <router-link to="/fxml/fx-reference" class="btn btn-next">&lt;fx:reference&gt; ❯</router-link>
    </div>
  </article>
</template>
