<template>
  <article class="content-area">
    ...
    <div class="pagination">
      <router-link to="/css/accordion" class="btn btn-prev">❮ Accordion</router-link>
      <router-link to="/css/buttonbase" class="btn btn-next">ButtonBase ❯</router-link>
    </div>
  </article>
</template>
