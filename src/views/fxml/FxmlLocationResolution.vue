...
&lt;/ImageView&gt;
      ...
      <div class="info-alert">
        ...
        like images, scripts, or stylesheets resolves to the location of the
        HTML file.
      </div>
      <div class="code-block">
        <div class="code-header">Example</div>
...
&lt;img src="/my_image.png" alt="Relative image" /&gt;
    ...
    <div class="pagination">
      <router-link to="/fxml/instance-properties" class="btn btn-prev"
        >❮ Instance Properties</router-link
      >
      <router-link to="/fxml/resource-resolution" class="btn btn-next"
