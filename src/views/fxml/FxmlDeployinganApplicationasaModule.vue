<template>
  <article class="content-area">
    <section class="doc-section glass-panel">
      ...
      <p>
        If <span class="code">FXMLLoader</span> is used to load types in a named
        module, the application must ensure that all types that are referenced
        in the FXML files, including the controller class and any custom
        <span class="code">Node</span> classes, are reflectively accessible to
        the <span class="code">javafx.fxml</span>
      ...
      <p>
        For example, if <span class="code">com.foo.MyController</span> is in the
    ...
    opens com.foo to javafx.fxml;
      ...
      <p>
        ...
        <span class="code">exports</span> the containing package
        unconditionally.
      </p>
      <hr />
      <p>
      ...
      <div class="info-alert">
        <strong>HTML Analogy:</strong> Module access rules in Java modules are
        similar to CORS (Cross-Origin Resource Sharing) policies in web
        applications, restricting which parts of an application can interact
        with resources from different domains or contexts.
      </div>
      <div class="code-block">
        <div class="code-header">Example</div>
...
&lt;script type="module" crossorigin="use-credentials" src="https://example.com/app.js"&gt;&lt;/script&gt;
    ...
    <div class="pagination">
      <router-link to="/fxml/custom-components" class="btn btn-prev"
