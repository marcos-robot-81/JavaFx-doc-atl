...
public class MyController {
    public void handleButtonAction() {
      ...
      <div class="info-alert">
        <strong>HTML Analogy:</strong> In web development, tying an event to a
        method in a separate class or script is a core feature of most frontend
        frameworks (like Vue, React, or Angular). Instead of placing the raw
        logic in the HTML attribute, you reference a function (the controller
        method) defined in your JavaScript or TypeScript component.
      </div>
      <div class="code-block">
        <div class="code-header">Web Equivalent (Vue.js)</div>
        <pre><code>&lt;!-- Template --&gt;
&lt;button @click="handleButtonAction"&gt;Click Me!&lt;/button&gt;
...
&lt;/script&gt;</code></pre>
    ...
    <div class="pagination">
      <router-link to="/fxml/script-event-handlers" class="btn btn-prev"
