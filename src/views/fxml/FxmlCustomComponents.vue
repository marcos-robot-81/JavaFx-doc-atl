...
hbox.getChildren().add(customControl);
      ...
      <div class="info-alert">
        <strong>Required Import:</strong> To use <code>&lt;HBox&gt;</code>, remember to add <code>&lt;?import javafx.scene.layout.HBox?&gt;</code> at the top of your FXML file.
      </div>
      <div class="code-block">
        <div class="code-header">Example</div>
        <pre><code>&lt;HBox&gt;
...
&lt;/HBox&gt;
      ...
      <div class="info-alert">
        ...
        conceptually identical to Web Components (Custom Elements) in HTML,
        where you define a reusable tag with its own encapsulated structure and
        behavior.
      </div>
      <div class="code-block">
        <div class="code-header">Example</div>
...
&lt;/script&gt;</code></pre>
    ...
    <div class="pagination">
      <router-link to="/fxml/fxmlloader" class="btn btn-prev"
