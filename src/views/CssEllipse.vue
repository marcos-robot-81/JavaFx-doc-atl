...
<p class="styleclass">Style class: empty by default</p>
    ...
    <div class="pagination">
      <router-link to="/css/cubiccurve" class="btn btn-prev">❮ CubicCurve</router-link>
      <router-link to="/css/line" class="btn btn-next">Line ❯</router-link>
    </div>
  </article>
</template>
